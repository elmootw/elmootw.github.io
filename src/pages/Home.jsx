        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          <Link to="/cyber-security">
            <div className="h-full rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition-all cursor-pointer border-4 border-blue-500 bg-white transform hover:scale-105">
              <div className="h-56 md:h-64 bg-gradient-to-b from-blue-200 to-blue-300 flex items-center justify-center">
              ...
              <div className="p-6">
                <h2 className="text-2xl md:text-3xl font-bold mb-3 text-gray-800">資訊安全 Cybersecurity</h2>
                <p className="text-gray-600 mb-4 line-clamp-3">擁有 7+ 年資安顧問服務經驗，專精於滲透測試、應用安全與資安事件應變。目前領導資安專業團隊，致力於提升企業安全防禦。</p>
          ...
          <Link to="/photography">
            <div className="h-full rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition-all cursor-pointer border-4 border-purple-500 bg-white transform hover:scale-105">
              <div className="h-56 md:h-64 bg-gradient-to-b from-purple-200 to-purple-300 flex items-center justify-center">
                <div className="text-center text-white">
                  <div className="text-6xl md:text-7xl mb-2">📷</div>
              ...
              <div className="p-6">
                <h2 className="text-2xl md:text-3xl font-bold mb-3 text-gray-800">攝影師 Photographer</h2>
                <p className="text-gray-600 mb-4 line-clamp-3">使用 Fujifilm 專業器材進行創意攝影，擅長人像、風景與商業攝影。以獨特的視角捕捉每個精彩時刻。</p>
